...
export default function LandingClient() {
  ...
  useEffect(() => {
    ...
    // with whileInView / scroll-triggered animations.
  ...
  return (
    <main className="min-h-screen bg-bg text-text overflow-x-hidden relative z-0">
      ...
      >
        ...
        >
          {[
            { title: "AES-256", desc: "File Encryption" },
            { title: "ML-KEM", desc: "Quantum-Safe Key Exchange" },
            { title: "Zero-Knowledge", desc: "Privacy Focused" },
          ].map((item) => (
            <div
              key={item.title}
